...
def get_version():
    ...
    with open(snake_base("seqchk.VERSION"), "r") as f:
        version = f.readline()
    return version
...
def print_citation():
    ...
    with open(snake_base("seqchk.CITATION"), "r") as f:
        for line in f:
            echo_click(line)
...
\b
CLUSTER EXECUTION:
seqchk run ... --profile [profile]
For information on Snakemake profiles see:
https://snakemake.readthedocs.io/en/stable/executing/cli.html#profiles
\b
RUN EXAMPLES:
Required:           seqchk run --input [file]
Specify threads:    seqchk run ... --threads [threads]
Disable conda:      seqchk run ... --no-use-conda 
Change defaults:    seqchk run ... --snake-default="-k --nolock"
Add Snakemake args: seqchk run ... --dry-run --keep-going --touch
Specify targets:    seqchk run ... all print_targets
Available targets:
